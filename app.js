...
<a href="https://vidlink.pro/download/movie/${movie.id || movieId}" target="_blank" rel="noopener noreferrer" class="download-btn primary-dl">
  <div class="dl-quality">1080p</div>
  <div class="dl-label">Full HD</div>
  <div class="dl-size">~2.4 GB</div>
</a>

<a href="https://vidlink.pro/download/movie/${movie.id || movieId}" target="_blank" rel="noopener noreferrer" class="download-btn secondary-dl">
